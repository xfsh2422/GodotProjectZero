...
const UI_LABEL: Dictionary = {
	...
	"harvest_forest_info": "与暗黑森林的裸露根系直接相连，从内部开发资源。",
	"watermark_title": "官方游戏页面",
	"watermark_info": "为了获取最新版本，请确认您在我维护和更新的官方网页进行游戏。",
	"dark_forest_title": "暗黑森林",
	"dark_forest_info": "您再次苏醒。小心，暗黑森林永不眠……",
	"spirit_effect": "剑士被动伤害",
	"essence_effect": "剑士点击伤害",
	"shadow_effect": "资源净收入",
	...
	"new_game": "新游戏",
	"import": "导入",
	"import_tooltip": "恢复之前的进度。",
	"import_placeholder": "请在此粘贴文件保存码",
	"import_error": "导入失败。请检查您的文件保存码，然后再试一次。",
	"export": "导出",
	"export_tooltip": "请复制并记住此文件保存码，以便以后恢复您的进度。",
	"import_title": "导入存档",
	"export_title": "导出存档",
	"unnamed": "未命名",
	...
	"music_tracks": "音乐选择",
	"dear_diary": "亲爱的日记",
	"resource_storage": "资源存量",
	"upgrade": "升级",
	"cost": "成本",
	"produce": "生产",
	"deaths_door": "死亡之门",
	"deaths_door_title": "敲响死亡之门",
	"deaths_door_info": "该生命体倒下，它命悬一线。请做出选择。",
	"deaths_door_first": "处死",
	"deaths_door_second": "赦免",
	"deaths_door_first_title": "处死",
	"deaths_door_second_title": "赦免",
	"deaths_door_first_info": "摧毁该生命体，将其痛苦的灵魂吸收进你的本质。",
	"deaths_door_second_info": "释放该生命体，将其灵魂从腐败的肉体监狱中释放。",
	"offline_1": "您离开了{0}。\n\n",
	"offline_2": "不快乐的属民将拒绝在无人监管时工作。",
	"offline_3": "保证资源不在减少，以保持属民快乐：",
	"offline_4": "自您上次活动以来，属民生产了：",
	"master": "主音量",
	"music": "背景音乐",
	"sfx": "音效",
	"shake": "抖动效果",
	...
	"fullscreen": "全屏",
	"heart_title": "暗黑森林之心",
	"heart_info": "诡秘的力量以邪恶的节奏跳动...我感觉它就像我的...不...是的...？",
	"heart_dialog": "摧毁心脏",
	"heart_yes": "我已准备好",
	"heart_no": "还未准备好",
	"heart_prestige_info_1": "您将重生。\n\n把每一个“无限”资源转换成奇点。",
	"heart_prestige_info_2": "您将离开这个世界。\n\n只会保留神圣的东西：本质、灵魂石、奇点。",
	"craft": "制造",
	"execute_mode_button": "总是处死",
	"manual_mode_button": "手动决策",
	"absolve_mode_button": "总是赦免",
	"normal_mode_button": "地方自治",
	"smart_mode_button": "绝对统治",
	"auto_mode_button": "自由石匠",
	"normal_mode_button_info": "逐个增加属民角色。",
	"smart_mode_button_info": "增加一个人口角色也会自动增加所有所需的角色。",
	"auto_mode_button_info": "激活时，过剩的农民将自动分配给石匠。",
	"infinity_progress_1": "{0}% 至无限 ({1})",
	"infinity_progress_2": "已收集{1}/{2}个无限。",
	"prestige_condition_info": "需要至少1个无限才能突破。",
	"reborn_1_line_2": "1. 不要崇拜任何高于你的权力。让野心成为你的催化剂。",
	"reborn_1_line_1": "   ",
	"reborn_2_line_2": "2. 制作你自己的偶像和符号。让它们引导你控制所需的力量。",
	"reborn_2_line_1": "   ",
	"reborn_3_line_2": "3. 诚心说出上古灵魂的名号召唤它们，使其服从你的意志。",
	"reborn_3_line_1": "   ",
	"reborn_4_line_2": "4. 每一刻都是对力量和统治的无情追求。",
	"reborn_4_line_1": "   ",
	"reborn_5_line_2": "5. 尊重那些拥有更强力量的生物，直到你能超越他们。",
	"reborn_5_line_1": "   ",
	"reborn_6_line_2": "6. 毫不犹豫地杀戮。每一次收获的物质都为你的升华提供燃料。",
	"reborn_6_line_1": "   ",
	"reborn_7_line_2": "7. 使用力量让任意生物效忠，只为你的利益服务。",
	"reborn_7_line_1": "   ",
	"reborn_8_line_2": "8. 将渴望的一切据为己有，所有生物都是你掠夺和操纵的对象。",
	"reborn_8_line_1": "   ",
	"reborn_9_line_2": "9. 欺骗那些愚信你的人，有目的地讲述真相是最好的武器。",
	"reborn_9_line_1": "   ",
	"reborn_10_line_2": "10. 贪婪占有所有能给予你力量的东西。寻找他人遗物，让众生向你的意志低头。",
	"reborn_10_line_1": "   ",
	"reborn_11_line_2": '"你是吞噬世界的黑暗。" - 修马 5:14',
	"reborn_11_line_1": "   ",
	"reborn_X_line_2": "",
	"reborn_X_line_1": "   "
}
...
const ENEMY_DATA_INFO: Dictionary = {
	"ambassador": "这头古老的巨兽挡住了去路，且拒绝让路。",
	"rabbit": "乍一看满脸天真无辜，它不希望被发现。",
	"bird": "被暗影触及的鸟大声警告你：“立即停止你的征途，人类。”",
	"wolf": "年老且无依无靠的银发野兽，它会战斗保护橡树和月亮的秘密。",
	"void": "这些侵入者本体极不稳定...在荒废的现实中漫无目的地漂流。",
	"spider": "界限的建筑师，她的网帮助挡住光的侵扰。",
	"dragon": "鳞片闪闪发光，双眼炽热如火，龙傲然站在城堡大门前。",
	"dino": "这头上古巨兽提议结盟，要你不再前进；但它知道这全然徒劳。",
	"skeleton": "骨骼发光的再生遗物，四周回荡着无限低语。",
	"slime": "恶心的污泥，移动迅速且动力十足，不愿交谈。",
	"angel": "灰色的火焰包围着这天界生物，脸被银色面具遮盖...它一言不发。"
}
...
=======
	...
	"coal": "煤炭",
	"common": "进行冒险，采集常见资源。",
	"compass": "导航穿过暗影迷雾；新的疯狂等待着。",
	"beacon": "蓝图从记忆迷雾中浮现。这需要...一颗灵魂？",
	"soul": "灵魂",
	"experience": "经验值",
	"fiber": "纤维",
	"firepit": "温暖、明亮、舒适；如父母的轻抚。",
	"flint": "燧石",
	"food": "食物",
	"fur": "毛皮",
...
const EVENT_DATA_TEXT: Dictionary = {
	"automation": "我们宣布，今天将是一个新时代的开始...自动化时代正式诞生！",
	"cat_gift": "那只纤弱的猫在储藏室制造了一场大混乱。不知怎的，清理后我们的原材料多了一倍。",
	"cat_no_gift": "猫的提议太可疑了。不敢想象如果接受，会发生什么。",
	"cat_intro_no": "我只知道这扭曲的森林，我敢称它为家吗？我是在自欺欺人吗？猫喵了一声，嘲笑我的回答。",
	"cat_intro_yes": "我必须承认我迷路了。猫咧嘴一笑，然后恢复了单调的面孔。",
	"cat_scam": "那只猫是不是骗了我？我...我说不出话来。信任的确捉摸不透。",
	"cat_watching": "有个像猫一样的东西潜伏在阴影中。它的存在让我感到极度不安。",
	"enemy_screen": "黑暗中出现了可疑的眼睛。它的凝视让我的属民感到恐惧。",
	"firepit_worker": "我遇到了一个古怪的陌生人，他在我的陪伴中找到了慰藉。我们一起点燃了火堆。火光点亮了他没有五官的面孔，他想要为我工作，换取庇护。",
	"gift_flint_fiber": "发现一堆早已熄灭的营火。生命痕迹的残余激发了希望。碎片中包含：{0} 纤维，{1} 燧石，{2} 木头和 {3} 石头。",
	"house_1": "迷失的人们从森林中出现。他们将为我工作，换取睡觉的地方。",
	"house_100": "即使在绝对黑暗中，我们的人数也在增长，生活欣欣向荣。孩子们欢笑嬉戏，而森林在暗中聆听。",
	"house_25": "这座森林村落远比我们那可怜的营地要好。",
	"house_4": "我在这些树木中留下了印记，雕刻出一个文明聚落。活泼的森林营地一天比一天热闹。",
	"house_capital": "我宣布这个定居点为森林的首都。向这片诅咒之地外发展，把我们的名字刻入这个世界。",
	"house_city": "城镇扩张得比我想象的要快，我可能需要帮助来管理这一切。",
	"house_empire": "森林的人民赋予了我皇帝称号。我的聚落只会继续扩张。",
	"house_imperium": "今天，我将作为森林帝国的皇帝，思考了数十亿人赋予我的巨大责任。",
	"house_kingdom": "我宣布，我将成为这片广阔土地的国王。人们都说，绝对权力会导致绝对腐败？",
	"house_megalopolis": "从虚空的子宫中诞生，一个巨大都市已经形成。它将在我金色的光芒中继续成长。",
	"house_metropolis": "数百万人...无面的类人...站在我身边。一条红毯引领我走向湮灭...",
	"house_town": "我的人民在我穿过街道时祈祷和鞠躬。这一定是幻觉？",
	"land_1": "附近有一片宜人的森林，闻起来像松树。",
	"land_10": "岩石山区有煤炭。命运将它放在了我们定居点旁边。",
	"land_11": "山的另一边有一个老矿场。我想不到什么可怜的生物会在这样的条件下辛苦劳作。",
	"land_spelunk": "洞穴在召唤，它们的深处隐藏在黑暗中。每一步都回响着被遗忘的恐怖。",
	"land_2": "一条浅溪流经森林。",
	"land_3": "好奇心驱使我走得更深，总有一天它会导致我的灭亡。",
	"land_4": "橡树和松树屹立不倒。我应该在这里开辟一片空地吗？",
	"land_5": "一座山脉延伸到森林附近。不知道我是否可以利用它。",
	"land_6": "深而黑暗的湖泊延伸到泥泞的海滩上。",
	"land_7": "森林深处传来低吼声。噩梦在我的内心深处编织。",
	"land_8": "广袤的土地延伸到森林之外，但我需要找到导航方式。",
	"land_9": "独自探索新土地会令人筋疲力尽。派出一些人探索听起来是个好主意。",
	"land_debug": "诸神赐予了丰富的资源来帮助你debug。",
	"resource_generated": "你生成了 {0} {1}。",
	"zero": "世界黑暗而空虚...",
	"darkness_1": "深入黑暗，我注意到我的人民在我身后，无面的小雕像... 他们曾经具有人性吗？",
	"darkness_2": "我走得比以前更远，我的人民却总是紧跟在我身后。时间和空间似乎扭曲了。",
	"darkness_3": "那匹狼不是第一个敌人，也不会是最后一个。征服它非常耗费体力，但我必须继续前行。",
	"darkness_4": "无数的灵魂围绕着倒下的怪物，但没有一个碰我。它们是在...害怕吗？",
	"darkness_5": "我的脑海中翻腾不断，视野扩张收缩。黑暗森林的路径将我带入循环。这个迷宫到底想让谁迷失在这里？",
	"darkness_6": "强大的龙曾是城堡大门看守。在大厅中，一头巨大的野兽直冲到无尽的天花板空隙中。",
	"darkness_7": "这一切太容易了。不。一定有什么不对。你...你还在这里，对吧？",
	"darkness_8": "走向王座室时，无数生命体聚集在一起。他们似乎认识我。王座室就在前方，我的心跳加速。",
	"darkness_9": "被打败的史莱姆微笑说：“你不记得了吗？你已经困在这个...形态...太久了。”",
	"darkness_10": "我击败了死神本身，目睹它的灵魂形态就在我的眼前重生。它留下了一个闪闪发光的...灵魂？我需要...更多。",
	"execute_1": "吸收黑暗精华时，我感受到一股力量冲刷我的身体...灼烧我的肉体。",
	"execute_2": "我吞噬了信使的精华。苦涩、有嚼劲且有些腐烂，但它让我能够飞翔。",
	"execute_3": "那只邪恶野兽的爆炸精华赋予了我极速。无论我跑多远，总是重回原点。",
	"execute_4": "我吸收了无数灵魂进入我的精华。它们在我体内哀嚎，持续回响淹没了我的思绪。",
	"execute_5": "守卫倒下了。我拿走了属于我的东西。消化这种精华让我拥有了比手指更多的肢体。",
	"execute_6": "龙的精华可能含有地狱之火，会灼烧舌头，但为了它的破坏力，这是值得的牺牲。",
	"execute_7": "知识就是力量。那头巨兽的精华教会了我这一点，然而我的名字仍是一个侵蚀我理智的谜。",
	"execute_8": "吞食黑暗精华时...我的思想...为何感觉如此脆弱却又如此强大？",
	"execute_9": "王子的精华在融合中迷失了。高贵血统的幻象困扰着我的思维。",
	"absolve_1": "一个甜蜜的精神从腐烂兔子的子宫中诞生，它快乐地跟随我的脚步。",
	"absolve_2": "一个新的盟友从倒下的鸟尸中崛起，它会侦察前方的路径。",
	"absolve_3": "狼躺在崎岖的小径上，抬起头来让人抚摸。这是一位指引前路的盟友。",
	"absolve_4": "灵魂不再哀嚎，它们的身影反射在粼粼涟漪之上。孩子们...",
	"absolve_5": "被赦免的蜘蛛精神跟随我前进，它闪闪发光的丝线编织了前路。",
	"absolve_6": "伟大的龙每天以善意报答我的怜悯。它燃烧黑暗的路径，它的神秘呼吸为土壤施肥。在烟雾和迷雾中升起了繁茂的绿色植物。",
	"absolve_7": "我与那头高大的野兽和解。这位温和的巨人把我举向王座室。",
	"absolve_8": "这个生命体...侍僧...它想要交谈？为什么我觉得它如此熟悉？为什么？为什么？为什么？",
	"absolve_9": "王子对我的怜悯嗤之以鼻，但它容忍我的愚行，同意随我前进。",
	"lore_beacon": "点亮的信标刺穿黑暗的天空。我第一次能看到星星...穿透深渊和树冠。",
	"heart_reveal": "星光照亮了黑暗森林的禁地，揭示了律动的来源。",
	"first_spirit": "重获自由的精神与剑士融合，赋予他们黑暗的力量。",
	"first_essence": "刚刚吞噬的精华让我能够吸取剑士的生命力，使我更加致命。",
	"soul_crafted": "这是...终点吗？"
}
...
const NPC_EVENT_TEXT: Dictionary = {
	...
	"cat_talk_A2": "我们很久没有遇到像...你这样的人了。",
	"cat_talk_A3": "我们不能浪费这个机会。我会帮助你。就这一次。",
	"cat_talk_A4": "我会使你的原材料加倍，说一声就行，但不要等太久...",
	"cat_talk_A4_1": "享受吧...明智地使用这些材料。我打算...继续观察。",
	...
	"cat_talk_B4_1_2": "你迟早会感谢我...在那之前，我不会走远...",
	"cat_talk_B4_2": "真的吗？你真古怪。我会留意你...",
	"cat_talk_C0": "你独自一人将它打败...我低估了你。",
	"cat_intro_1": "气味出卖了你的身份...你不可能完全是人类，对吧？",
	"cat_intro_1_1": "真奇怪。你看起来很熟悉，但你的气味...我不认识。",
...
const SUBSTANCE_TEXT: Dictionary = {
	...
	"essence_bird_title": "无望信使的本质",
	"essence_wolf_title": "负疚防御者的本质",
	"essence_void_title": "尖叫虚空的本质",
	"essence_spider_title": "被遗忘的守卫者的本质",
	"essence_dragon_title": "堕落守护者的本质",
	"essence_dino_title": "注定失败使者的本质",
	"essence_skeleton_title": "可怕侍僧的本质",
	"essence_slime_title": "疯狂王子的本质",
	"essence_angel_title": "无意义死亡的本质",
	"spirit_ambassador_info": "这头古老的巨兽挡在通往森林边缘的道路上。",
	"essence_ambassador_info": "它独自站在森林的边缘。没有人离开，没有人进入。",
	"spirit_rabbit_info": "尽管身受重创且濒临死亡，兔子的脸上还是浮现出一丝微笑。",
	"essence_rabbit_info": "曾经纯真的心，现在永远被深渊玷污。",
	"spirit_bird_info": "尽管受伤，这只野兽仍发出警告。它的嚎叫深入森林。",
	"essence_bird_info": "它悠远的鸣叫讲述了一个有关灾厄的故事，甚至在这片诅咒森林之外也常能听到这个故事。",
	"spirit_wolf_info": "曾经忧郁的狼在你的照顾下找到了新的目标。不要让它失望。",
	"essence_wolf_info": "它漫无目的地徘徊，窥视黑暗中的某人...或某物...",
	"spirit_void_info": "这头融合体不再哀嚎，它在你身边轻松地漂浮，哼着一首俏皮的童谣。",
	"essence_void_info": "无中生有，它哀嚎着，怀念着甜美的不存在之感。",
	"spirit_spider_info": "她织着网，阻挡前方的无限虚空。蛛丝的反射带来了愉快的梦境。",
	"essence_spider_info": "她编织了奇迹和梦境的网，但不巧，她失去了自己的梦...",
	"spirit_dragon_info": "它曾是监狱守卫，现在成为了狱监。它的鳞片在夜空下闪闪发光，为前方的道路洒下辉煌的光芒。",
	"essence_dragon_info": "它生前是一只野兽，现在却被黑暗本身束缚。",
	"spirit_dino_info": "万物生灵的前身站在你身边，与其他游荡的灵魂无异...",
	"essence_dino_info": "生命起源对许多人仍是一个谜，但它声称知道答案...",
	"spirit_skeleton_info": "有关希望的低语绕着它回响：“骸骨记录着万事万果...”",
	"essence_skeleton_info": "它在蜿蜒的泥土小径上跋涉，向头顶的星星乞求怜悯...",
	"spirit_slime_info": "尽管屡遭失败，这个史莱姆仍在试图恢复其尊贵形态。",
	"essence_slime_info": "即使死亡，它虚无的形态仍轻轻地脉动。恳求你给它真正的了解。",
	"spirit_angel_info": "“这个人，”他指向自己，“不配蒙受怜悯。”",
	"essence_angel_info": "死亡平等地降临于所有人。这一真理给一些人带来安慰，给另一些人带来恐惧。",
	"heart_title": "黑暗森林之心",
	"heart_info": "+100% - 阴影迷雾通过切断的静脉渗透，转化附近的物质……",
	"flesh_title": "黑暗森林之肉",
	"flesh_info": "+1% - 1/10 - 在你的触摸下微弱地跳动，仿佛它承载着森林本身的心跳。",
	"eye_title": "黑暗森林之眼",
	"eye_info": "+5% - 1/100 - 这只眼睛凝视深渊，揭示了隐藏在阴影深处的隐藏真相。",
	"bone_title": "黑暗森林之骨",
	"bone_info": "+50% - 1/1000 - 未知的古老骨头低语着被遗忘的诅咒。",
	"the_hermit_title": "隐士",
